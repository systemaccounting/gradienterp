...
resource "aws_s3_object" "canonical_metric_queries" {
  bucket = aws_s3_bucket.canonical_schemas.id
  key    = "metric_queries.json"
  source = "${path.module}/../../modules/schemas/data/metric_queries.json"
  etag   = filemd5("${path.module}/../../modules/schemas/data/metric_queries.json")
