...
- `bash scripts/current-spend.sh [YYYY-MM]` — what AWS has cost this month (or that month), org-wide: the total, the run rate, each account by name with its services. Cost Explorer in the management account, the default profile
